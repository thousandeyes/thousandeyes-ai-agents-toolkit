...
| Skill | Description |
| --- | --- |
| [thousandeyes-alert-rule-management](skills/thousandeyes-alert-rule-management/SKILL.md) | Create, update, or delete ThousandEyes alert rules with MCP tools. Use when a user wants help translating alert-rule documentation and expression metadata into the supported `create_alert_rule`, `update_alert_rule`, and `delete_alert_rule` arguments. |
