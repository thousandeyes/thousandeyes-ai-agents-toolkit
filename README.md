...
| Skill | Description |
| --- | --- |
| [thousandeyes-synthetic-test-management](skills/thousandeyes-synthetic-test-management/SKILL.md) | List, inspect, create, update, delete, or validate ThousandEyes synthetic tests with MCP tools. Use when a user wants to manage Network & App Synthetics tests, run instant checks before creating a scheduled test, deploy template-based SaaS monitoring, or clean up existing tests. |
